package com.mvp.common.retrofit_rx.download;


import com.mvp.common.retrofit_rx.download.downloadlistener.DownloadInterceptor;
...
import com.mvp.common.retrofit_rx.subscribers.ProgressDownSubscriber;
    ...
    public void startDown(final DownInfo info){
        ...
        if(downInfos.contains(info)){
            ...
            Retrofit retrofit = new Retrofit.Builder()
                    ...
                    .baseUrl(AppSession.getInstance().getBasUrl(info.getUrl()))
                    .build();
        ...
        httpService.download("bytes=" + info.getReadLength() + "-",info.getUrl())
                ...
                /*数据回调*/
                .toFlowable(BackpressureStrategy.LATEST).subscribe(subscriber);
