...
import com.mvp.common.retrofit_rx.download.DownInfo;
import com.mvp.common.retrofit_rx.download.DownState;
import com.mvp.common.retrofit_rx.download.HttpDownManager;
import com.mvp.common.retrofit_rx.download.downloadlistener.DownloadProgressListener;
import com.mvp.common.retrofit_rx.listener.HttpDownOnNextListener;
import com.mvp.common.retrofit_rx.utils.DbDownUtil;
 ...
 */
public class ProgressDownSubscriber<T extends BaseResultEntity> extends ResourceSubscriber<T> implements DownloadProgressListener {
    //弱引用结果回调
