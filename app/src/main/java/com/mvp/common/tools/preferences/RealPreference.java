...
public class RealPreference<T> implements Preference<T> {
  /** Stores and retrieves instances of {@code T} in {@link SharedPreferences}. */
  public interface Adapter<T> {
    /** Retrieve the value for {@code key} from {@code com.zealfi.common.tools.preferences}. */
  ...
  public RealPreference(SharedPreferences preferences, final String key, T defaultValue,
